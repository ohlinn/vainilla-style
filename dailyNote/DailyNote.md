### Filled sample
```<div class="daily"> <div class="todayday"> <span> sunday 24 </span> </div>
<div class="todaymonth"> <span> ෴july 2021෴ </span> </div> </div>
<div class="bars"> <div class="bars-progres">
<div class="time"> <span> <a class="internal-link" id="big-link" href=" 21-w29.md"> week 29 </a> </span> </div>
<div class="left"> <span> <a class="internal-link" id="small-link" href=" 21-07-23.md"> yesterday </a> 🟊
<a class="internal-link" id="small-link" href=" 21-07-25.md"> tomorrow </a> </span> </div>
<progress value="6" max="7"> </div>
<div class="bars-progres">
<div class="time"> <a class="internal-link" id="big-link" href=" 21-07-00.md"> july </a> </div>
<div class="left"> <span> 🝮 7 days left </span> </div>
<progress value=" 24" max="31"> </div>
<div class="bars-progres">
<div class="time"> <a class="internal-link" id="big-link" href=" 21-Quarter3.md"> 3º quarter </a> </div>
<div class="left"> <span> 🝮 68 days left </span> </div>
<progress value="24" max="92"> </div>
<div class="bars-progres">
<div class="time"> <a class="internal-link" id="big-link" href="_Index_00. Bitácora.md"> Day #205 </a> </div>
<div class="left"> <span> 🝮 160 days left </span> </div> <progress value="205" max="365"> </div>
```
...
<div class='bars'>
    ...
    <div class='bars-progres'>
        <div class='time'><a class='internal-link' id='big-link'
                href='<% tp.date.now('YYYY', 0, tp.date.now('YY-MM-DD', 0, tp.file.title, 'YY-MM-DD'), 'YY-MM-DD') %></a>.md'>Day
                #<% moment(tp.file.title, 'YY-MM-DD').dayOfYear() %></a></div>
        <div class='left'>🝮
            <% moment(moment(tp.file.title, 'YY-MM-DD').endOf('year')).diff(moment(tp.file.title, 'YY-MM-DD'), 'days') %>
            days left</div>
